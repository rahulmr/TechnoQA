...
'Click on DropDown arrow of the topbar'
WebUI.click(findTestObject('CreateNewDashboardAndTab/Page_CreateNewDashboard/div_dashboard-actions-holder f'))

'Click on "Add Dashboard" Button in the menu'
