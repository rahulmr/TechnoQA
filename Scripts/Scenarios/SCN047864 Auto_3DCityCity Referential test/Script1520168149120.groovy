...
WebUI.callTestCase(findTestCase('TabFunctions/CreateNewTab'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('CompassFunctions/SmallCompassWest'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Techno_3DCityFunctions/DragDropCityReferentialWidget'), [:], FailureHandling.STOP_ON_FAILURE)
