...
WebUI.setText(findTestObject('Techno_3Dcity_DDCityReferential/Page_SearchAppInCompass/input_compass-search-text form'), 
    'Rendering Studio', FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.dragAndDropToObject(findTestObject('Techno_RenderingStudio/Page_RenderingStudio/li_Rendering Studio'), findTestObject(
        'Techno_RenderingStudio/Page_RenderingStudio/div_wp-tabview-panel'), FailureHandling.CONTINUE_ON_FAILURE)
